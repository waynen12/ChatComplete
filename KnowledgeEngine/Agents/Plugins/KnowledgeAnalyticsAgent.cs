...
/// <summary>
/// Agent plugin for providing comprehensive knowledge base analytics and summary information.
/// </summary>
public sealed class KnowledgeAnalyticsAgent
{
    ...
    {
        Console.WriteLine(
            $"📚 KnowledgeAnalyticsAgent.GetKnowledgeBaseSummaryAsync called - includeMetrics: {includeMetrics}, sortBy: {sortBy}"
        );
        ...
        {
            Console.WriteLine($"❌ Error in GetKnowledgeBaseSummaryAsync: {ex.Message}");
    ...
    private async Task<KnowledgeBaseSummary> GetKnowledgeBaseDetailedSummaryAsync(string knowledgeId)
    {
        ...
        {
            Console.WriteLine($"⚠️ Error getting details for knowledge base {knowledgeId}: {ex.Message}");
        }
    ...
    private async Task EnrichWithUsageStatisticsAsync(KnowledgeBaseSummary summary)
    {
        ...
        {
            Console.WriteLine($"⚠️ Error getting usage stats for {summary.KnowledgeId}: {ex.Message}");
