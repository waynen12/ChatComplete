        ...
        string? ollamaModel = null)
    {
        ...
        switch (provider)
        {
            case AiProvider.OpenAi:
                ...
                var openAiChatClient = openAiClient.GetChatClient(_settings.OpenAIModel).AsIChatClient();

                agent = tools != null
                    ? openAiChatClient.AsAIAgent(instructions: systemPrompt, tools: [.. tools])
                    : openAiChatClient.AsAIAgent(instructions: systemPrompt);
