...
public static class ServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services
            .AddHttpClient<OpenAIProviderApiService>(client =>
            {
            ...
            .ConfigurePrimaryHttpMessageHandler(
                (serviceProvider) =>
                {
                    ...
                    var bypassSslValidation = config.GetValue<bool>(
                        "Development:BypassSslValidation",
                        false
                    );
        ...
        services.Configure<BackgroundSyncOptions>(
            configuration.GetSection("Analytics:BackgroundSync")
        );
