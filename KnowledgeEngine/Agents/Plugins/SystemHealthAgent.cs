...
/// <summary>
/// Agent plugin for comprehensive system health monitoring and reporting
/// Provides intelligent health insights and recommendations
/// </summary>
public class SystemHealthAgent
{
    private readonly ISystemHealthService _systemHealthService;
    private readonly ILogger<SystemHealthAgent> _logger;

    public SystemHealthAgent(ISystemHealthService systemHealthService, ILogger<SystemHealthAgent> logger)
    {
    ...
    )
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Getting system health - scope: {Scope}, detailed: {Detailed}", 
    ...
    )
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Checking component health - {ComponentName}", componentName);
    ...
    )
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Getting system metrics - focus: {Focus}", focus);
    ...
    )
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Getting health recommendations");
        ...
        {
            _logger.LogError(ex, "Error getting health recommendations");
    ...
    public async Task<string> GetAvailableComponentsAsync()
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Getting available components");
    ...
    public async Task<string> GetQuickHealthOverviewAsync()
    {
        try
        {
            _logger.LogInformation("SystemHealthAgent: Getting quick health overview");
        ...
        {
            _logger.LogError(ex, "Error getting quick health overview");
