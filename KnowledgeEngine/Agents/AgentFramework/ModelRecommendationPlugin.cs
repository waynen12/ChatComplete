...
/// <summary>
/// Agent Framework plugin for providing model recommendations based on usage statistics and performance metrics.
/// Migrated from Semantic Kernel's ModelRecommendationAgent.
/// </summary>
public sealed class ModelRecommendationPlugin
{
    private readonly IUsageTrackingService _usageTrackingService;

    public ModelRecommendationPlugin(IUsageTrackingService usageTrackingService)
    {
    ...
    {
        Console.WriteLine(
            $"🏆 [AF] ModelRecommendationPlugin.GetPopularModelsAsync called - count: {count}, period: {period}, provider: {provider}"
        );
        ...
        {
            Console.WriteLine($"❌ [AF] ModelRecommendationPlugin error: {ex.Message}");
    ...
    {
        Console.WriteLine(
            $"📊 [AF] ModelRecommendationPlugin.GetModelPerformanceAnalysisAsync called - model: {modelName}, provider: {provider}"
        );
        ...
        {
            Console.WriteLine(
                $"❌ [AF] ModelRecommendationPlugin performance analysis error: {ex.Message}"
            );
    ...
    {
        Console.WriteLine(
            $"⚖️ [AF] ModelRecommendationPlugin.CompareModelsAsync called - models: {modelNames}, focus: {focus}"
        );
        ...
        {
            Console.WriteLine($"❌ [AF] ModelRecommendationPlugin comparison error: {ex.Message}");
